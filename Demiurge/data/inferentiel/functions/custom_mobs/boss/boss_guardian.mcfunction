...
data modify entity @s Attributes[0] set value {Name:"generic.maxHealth",Base:600.0d}
...
data modify entity @s DeathLootTable set value "inferentiel:entities/boss/guardian"