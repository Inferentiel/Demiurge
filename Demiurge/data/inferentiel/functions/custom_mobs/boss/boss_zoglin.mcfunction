data merge entity @s {CustomNameVisible:1b,CustomName:"{\"text\":\"Boss\",\"color\":\"red\",\"bold\":\"true\",\"italic\":\"false\"}",Passengers:[{id:"minecraft:zombified_piglin",HandItems:[{id:"minecraft:crossbow",Count:1b},{}]}]}
...
attribute @s minecraft:generic.attack_knockback base set 10
data modify entity @s Health set value 800.0f
data modify entity @s DeathLootTable set value "inferentiel:entities/boss/zoglin"