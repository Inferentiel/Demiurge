...
data modify entity @s Attributes[2] set value {Name:"generic.movementSpeed",Base:0.65d}
...
data modify entity @s DeathLootTable set value "inferentiel:entities/boss/evoker"